"""
Jina v3 dense retrieval evaluator.
"""
import logging
...
class JinaV3Evaluator(BaseEvaluator):
    """Evaluator for Jina v3 dense retrieval."""
    ...
    def __init__(
        ...
        **kwargs
        ...
        Args:
            ...
            model_id: HuggingFace model ID for Jina v3
        ...
        # Initialize model
        logger.info(f"Loading Jina v3 model: {model_id}")
        ...
        logger.info(f"Jina v3 evaluator initialized with {len(self.doc_embeddings)} document embeddings")
    ...
    def _retrieve(self, query: str, top_k: int = 100) -> List[str]:
        """
        Retrieve top-k documents for a given query using Jina v3 dense embeddings.
    ...
    def get_model_info(self) -> Dict:
        """Get information about the Jina v3 model."""
